...
var file_hello_proto_rawDesc = []byte{
	...
	0x22, 0x00, 0x12, 0x32, 0x0a, 0x0d, 0x4c, 0x6f, 0x74, 0x73, 0x4f, 0x66, 0x52, 0x65, 0x70, 0x6c,
...
var file_hello_proto_depIdxs = []int32{
	...
	0, // 1: Hello.LotsOfReplies:input_type -> HelloRequest
	1, // 2: Hello.SayHello:output_type -> HelloResponse
	1, // 3: Hello.LotsOfReplies:output_type -> HelloResponse
...
func (c *helloClient) LotsOfReplies(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Hello_LotsOfRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Hello_serviceDesc.Streams[0], "/Hello/LotsOfReplies", opts...)
	if err != nil {
		return nil, err
	}
